...
with open("C:/Users/Lukas/Desktop/last50Days2016.json", "r") as fp:
...
values = []
with open("C:/Users/Lukas/Desktop/last50Days2015.json", "r") as fp:
    plotdata = json.load(fp)
...
plt.xlabel("Time")
plt.ylabel("Total number of users every day active in the past 50 days")
