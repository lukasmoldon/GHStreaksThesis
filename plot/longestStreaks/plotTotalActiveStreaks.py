...
with open("C:/Users/Lukas/Desktop/activeStreaks2016.json", "r") as fp:
...
values = []
with open("C:/Users/Lukas/Desktop/activeStreaks2015.json", "r") as fp:
    plotdata = json.load(fp)
...
plt.xlabel("Time")
plt.ylabel("Total number of active streaks >= 15")
