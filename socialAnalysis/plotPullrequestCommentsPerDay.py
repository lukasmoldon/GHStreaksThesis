...
if not weekly:
    if total:
        plt.ylabel("Total number of comments on pull requests per day")
    else:
        plt.ylabel("Number of comments on pull requests per user per day")
else:
    if total:
        plt.ylabel("Avg total number of comments on pull requests per day in week")
    else:
        plt.ylabel("Avg number of comments on pull requests per user per day in week")
