...
users_observed = 0
if before:
    path_results = "/home/lmoldon/results/survivalAroundLastRecordMIN" + str(minlen) + "DIST" + str(maxdistance) + "BEFORE.json"
    ...
    path_results = "/home/lmoldon/results/survivalAroundLastRecordMIN" + str(minlen) + "DIST" + str(maxdistance) + "AFTER.json"
